    ...
    <body>
        ...
        <div class="card card-container">
            ...
            <form class="form-signin">
                ...
                <input type="text" onfocus="(this.type='date')" onblur="(this.type='text')" id="inputBday" class="form-control" placeholder="Birthday" required >
                <input type="number" id="inputContact" class="form-control" placeholder="Contact number" required >
                <input type="email" id="inputEmail" class="form-control" placeholder="Email address" required >
                <input type="password" id="inputPassword" class="form-control" placeholder="Password" required>
                <div id="terms" class="checkbox-inline">
                    <label>
                        <input type="checkbox" value="remember-me"> Do you agree with our terms and conditions?
                    </label>
                </div>
